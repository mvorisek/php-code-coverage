    ...
    public function testHeavyIndentationIsHandledCorrectly(): void
    {
        ...
        $this->assertEquals(
            [
                ...
                31,
                42,
                // 44 is variable but part of property fetch, must NOT be present
                46,
                50,
                54,
                60,
                ...
                134,
                138,
                162, // This shouldn't be marked as LoC, but it's high unlikely to happen IRL to have $var = []; on multiple lines
                165,
                169,
                172,
                180,
